...
import { deleteUserInfo, getOrderList, getUserAddress, getUserInfo, updateUserInfo } from "./api";
    ...
    const fetchUserInfo = async () => {
      try {
        ...
        if (userResponse.success && userResponse.data) {
          ...
          const orderResponse = await getOrderList({ userId: userResponse.data.id })
    ...
    <div>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <InputRow icon={User} id="name" type="text" value={editedInfo.fullname} onChange={(e) =>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <InputRow icon={Mail} id="email" type="email" value={editedInfo.email} onChange={(e) =>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <InputRow icon={Phone} id="phone" type="tel" value={editedInfo.phone} onChange={(e) =>
          ...
          <OrderHistory orderList={orderList} onNavigateToOrders={onNavigateToOrders} />
